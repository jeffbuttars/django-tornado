# Ensure we get the local copy of django-tornado instead of what's on the standard path
import os
import sys
sys.path.insert(0, os.path.abspath("../src/"))
import django_tornado

master_doc = "index"

project = "DjangoTornado"
copyright = "2011, Facebook"

version = release = django_tornado.version
...
latex_documents = [
    ('documentation', 'django-tornado.tex', 'DjangoTornado Documentation',
     'DjangoTornado', 'manual', False),
    ]
